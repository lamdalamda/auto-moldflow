...
class studymod(object):
    ...
    def generatebat(self):
        ...
        for i in range(0,len(self.xmls)):
            self.studymodbat.write(self.studymodpath+" D:\\internjob\\Done\\python\\20201023CRIMS\\CRIMS-automoldflow\\backup\\"+self.studyfile+" D:\\internjob\\Done\\python\\20201023CRIMS\\CRIMS-automoldflow\\backup\\"+self.xmls[i]+".sdy D:\\internjob\\Done\\python\\20201023CRIMS\\CRIMS-automoldflow\\backup\\"+self.xmls[i]+"\n")
